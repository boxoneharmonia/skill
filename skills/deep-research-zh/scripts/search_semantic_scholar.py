...
TOP_CONFERENCES = {
    # 经济学“Top 5”
    "The American Economic Review", "Econometrica", "Journal of Political Economy", 
    "Quarterly Journal of Economics", "Review of Economic Studies",
    # 农业经济与政策核心期刊
    "American Journal of Agricultural Economics", "Food Policy", "Agricultural Economics",
    "Journal of Agricultural Economics",
    # 农业系统与生态交叉
    "Agricultural Systems", "Ecological Economics", "Global Food Security"
}
